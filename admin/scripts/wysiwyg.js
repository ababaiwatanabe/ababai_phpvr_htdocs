...
var WYSIWYG = {
	...
	"bold":           ['Bold',                 'ÂÀ»ú',               	'bold.gif',               'bold_on.gif'],
	"italic":         ['Italic',               '¼ÐÂÎ',             	'italics.gif',            'italics_on.gif'],
	"underline":      ['Underline',            '²¼Àþ',          	'underline.gif',          'underline_on.gif'],
	"strikethrough":  ['Strikethrough',        'ÂÇ¾ÃÀþ',      	'strikethrough.gif',      'strikethrough_on.gif'],
	...
	"forecolor":      ['ForeColor',            'Ê¸»ú¿§',          	'forecolor.gif',          'forecolor_on.gif'],
	"backcolor":      ['BackColor',            'ÇØ·Ê¿§',          	'backcolor.gif',          'backcolor_on.gif'],
	...
	"insertimage":    ['InsertImage',          '²èÁüÁÞÆþ',        	'insert_picture.gif',     'insert_picture_on.gif'],
	"createlink":     ['CreateLink',           'Create Link',         	'insert_hyperlink.gif',   'insert_hyperlink_on.gif'],
	"viewSource":     ['ViewSource',           'HTML',         	'view_source.gif',        'view_source_on.gif'],
